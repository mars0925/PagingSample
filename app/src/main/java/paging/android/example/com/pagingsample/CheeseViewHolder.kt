...
/**
 * It a A simple ViewHolder that can bind a Cheese or Separator item.lso accepts null items since
...
class CheeseViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
    ...
    fun bindTo(item: CheeseListItem?) {
        ...
        cheese = (item as? CheeseListItem.Item)?.cheese //將資料的items給CheeseViewHolder的參數，這樣才能透過CheeseViewHolder找到這筆資料
        //nameView.text = item?.name
    }
}
