...
class MainActivity : AppCompatActivity() {
    lateinit var binding: ActivityMainBinding
        private set
    //改寫ViewModelFactory 讓 CheeseViewModel可以從建構式傳入 CheeseDao
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // collectLatest是flow的功能，功能不太確定，先跳過
        //將取得的資料設定給adapter
    ...
    private fun initSwipeToDelete() {
        ItemTouchHelper(object : ItemTouchHelper.Callback() {
            ...
            // 透過viewHolder 找到要刪除的 item，在viewHolder有設定cheese變數
            //在CheeseViewHolder裏面有寫，將資料的items給CheeseViewHolder的參數，這樣才能透過CheeseViewHolder找到這筆資料
